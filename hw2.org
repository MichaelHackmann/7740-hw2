...
#+begin_src python :results output
  ...
  chart_parser = nltk.RecursiveDescentParser(grammar)
...
#+results:
: Sentence: 'We had a long walk to the park and Vinny played with three other dogs.' took 1.1222 seconds to parse 1000 times.
: Sentence: 'It was sunny today but might not be tomorrow.' took 0.6089 seconds to parse 1000 times.
: Sentence: 'There are 49 angels dancing on the head of this pin.' took 1.0108 seconds to parse 1000 times.
...
"Tess" wasn't in the doman. I downloaded the sem2.fcfg file on my local
